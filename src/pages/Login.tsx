  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, hsl(269,57%,56%), transparent 70%)", transform: "translate(30%, -30%)" }}
      />
      <div
        className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full opacity-15 blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, hsl(282,54%,70%), transparent 70%)", transform: "translate(-30%, 30%)" }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(circle, hsl(269,57%,26%) 1px, transparent 1px)",
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            >
              ...
              <p className="text-xs font-bold font-mono" style={{ color: "hsl(var(--primary))" }}>
                9988776600
              </p>
            </div>
            <div
