          ...
          <React.Fragment key={num}>
            <div className="flex flex-col items-center gap-1">
                ...
                style={{
                  background: done
                    ...
                    : active
                      ...
                      : "hsl(var(--primary) / 0.1)",
                  color: done || active ? "white" : "hsl(var(--primary))",
                  boxShadow: active ? "0 0 0 4px hsl(var(--primary) / 0.15)" : "none",
                }}
              >
              ...
              <span
                ...
                style={{ color: active ? "hsl(var(--primary))" : "hsl(0,0%,60%)" }}
              >
                {label}
              </span>
            </div>
            {i < steps.length - 1 && (
              <div
                ...
                style={{ background: done ? "hsl(var(--primary))" : "hsl(var(--primary) / 0.15)" }}
              />
            )}
          </React.Fragment>
        );
        ...
        {step === 2 && qrData && (
          <div className="space-y-4">
            ...
            <div
              ...
              style={{ background: "white", borderColor: "hsl(var(--primary) / 0.2)" }}
            >
              {qrCodeIsImage ? (
            ...
            <div>
              ...
              <div className="relative">
                <div
                  ...
                  style={{ background: "hsl(var(--primary) / 0.1)" }}
                >
                  <KeyRound className="w-3.5 h-3.5" style={{ color: "hsl(var(--primary))" }} />
                </div>
                <input
                  type="text"
                  placeholder="000000"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
          {[
            ...
            <div
              ...
              style={{ background: "white", borderColor: "hsl(var(--primary) / 0.15)" }}
            >
        ...
        {!getUsersLoading && users.length > 0 && (
          <div className="rounded-2xl border border-border bg-background shadow-sm overflow-hidden">
            ...
            <div
              ...
              style={{ background: "hsl(var(--primary) / 0.06)", borderBottom: "1px solid hsl(var(--primary) / 0.15)", color: "hsl(var(--primary))" }}
            >
              <span>Username</span>
              <span>Email</span>
              <span>Role</span>
