...
const inputClass =
  ...
  + " focus:border-[hsl(var(--primary))] focus:shadow-[0_0_0_3px_hsl(var(--primary)/0.12)]";
...
const SectionHeader = ({ icon: Icon, title }: { icon: any; title: string }) => (
  <div className="flex items-center gap-2 mb-4">
    ...
    <div className="flex-1 h-px ml-1" style={{ background: "hsl(var(--primary) / 0.15)" }} />
  </div>
);
  ...
  `}
            ...
            {mediaItems.length === 0 && !uploadingMedia && (
              <div
                ...
                style={{ background: "hsl(var(--primary) / 0.04)", border: "1px dashed hsl(var(--primary) / 0.2)" }}
              >
